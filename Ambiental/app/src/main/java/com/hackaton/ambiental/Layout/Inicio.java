package com.hackaton.ambiental.Layout;
...
import com.hackaton.ambiental.R;
import com.hackaton.ambiental.Servicio.Nube;
...
public class Inicio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch(AmbientalC.user){
            case ADMINISTRADOR:
                break;
            case CLIENTE:
                break;
            case SERVICIO:
                intent= new Intent(this, Nube.class);
                startService(intent);
                notificar = new Timer();
                notificar.schedule(new TimerTask() {
                    @Override
                    public void run() {
                        new ACs().execute();
                    }
    ...
    public class ACs extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            if(getInternetConnection()){
                MessageEO datos= sesion.obtenerRegistros();
